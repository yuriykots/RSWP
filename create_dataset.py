...
train_img_paths = img_paths[0: int(0.8*len(img_paths))]
train_img_labels = img_labels[0: int(0.8*len(img_labels))]
dev_img_paths = img_paths[int(0.8*len(img_paths)):int(0.9*len(img_paths))]
dev_img_labels = img_labels[int(0.8*len(img_labels)):int(0.9*len(img_labels))]
test_img_paths = img_paths[int(0.9*len(img_paths)):]
test_img_labels = img_labels[int(0.9*len(img_labels)):]
